...
export default function SponsorFormSubmissionsCard({ data }) {
  return (
    <div className="grid grid-cols-12 gap-4 px-4 py-3 hover:bg-gray-50 transition-all duration-200 items-start text-sm">
      ...
      <div className="col-span-2">
        <span className="poppins-medium">{data.company}</span>
      </div>
      <div className="col-span-1">
        <span className="poppins-medium">{data.jobTitle}</span>
      </div>
      <div className="col-span-1">
        <span className="poppins-medium">{data.email}</span>
      </div>
      <div className="col-span-2">
        <span className="poppins-medium">{data.packageLevel}</span>
      </div>
      <div className="col-span-2">
