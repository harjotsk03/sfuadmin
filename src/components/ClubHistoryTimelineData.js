...
import ClubHistoryTimelineDataCard from "./ClubHistoryTimelineDataCard";
import AddDataModal from "./AddDataModal";
export default function ClubHistoryTimelineData() {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row gap-4 justify-between items-center py-4">
        <h1 className="text-xl poppins-semibold">Club History Timeline Data</h1>
        <button
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-2 text-sm text-gray-500">
              ...
              <div className="col-span-2 flex items-center gap-1">Date</div>
